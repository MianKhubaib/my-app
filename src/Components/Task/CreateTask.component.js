...
const CreateTask = ({  tasks }) => {
  ...
  const obj={'message': newmessage,'due_date':newDate,'assigned':newassigned,'priority':Newpriority}
  ...
  return (
    ...
    <div className="tc">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input className="f2 bg-near-white border grow shadow-5" type="submit" value="Submit"  onClick={()=>tasks.push(obj)}/>
      </form>
